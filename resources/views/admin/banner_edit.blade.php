...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">首页banner管理--编辑</h1>
        <h1 class="pull-right">
               ...
               <div class="row">
                    <form id="subform" method="POST" action="" accept-charset="UTF-8">                       
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="form-control"  style="width:320px;" name="url" placeholder="请输入跳转链接" value="{{$listArr->url}}">
                        </div>
                        
                        <div class="form-group form-inline col-sm-12">
                            <label class="form-label pull-left col-sm-2" style="text-align: right;">排序:</label>
                            <input class="form-control"  style="width:160px;" name="sid" placeholder="请输入排序" value="{{$listArr->sid}}">
                        </div>
                        <div class="form-group col-sm-12">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control"  style="width:320px;" name="sharecontent">{{$listArr->sharecontent}}</textarea>
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="btn btn-primary ajaxformsubmit" dataurl="{{route('admin.banner.ajaxedit')}}" type="button" value="保存">
