...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">{{$gameArr->name}}--详情添加</h1>
    </section>
               ...
               <div class="row">
                    <form id="subform" method="POST" action="" accept-charset="UTF-8">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control"  style="width:320px;" name="txt" placeholder="请输入内容"></textarea>  >
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="btn btn-primary ajaxformsubmit" dataurl="{{route('admin.games.ajaxaddcontent')}}" type="button" value="保存">
