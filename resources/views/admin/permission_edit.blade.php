               ...
               <div class="row">
                    <form id="subform" method="POST" action="" accept-charset="UTF-8">
                        ...
                        <div class="form-group form-inline  col-sm-12">
                            ...
                            <input class="form-control" style="width:320px;" name="label" type="text" placeholder="请输入权限解释名称" value="{{$listArr->label}}"> *例如： 权限添加
                        </div>

                        <div class="form-group form-inline  col-sm-12">
                            <label class="form-label pull-left col-sm-2" style="text-align: right;">权限名:</label>
                            <input class="form-control" style="width:320px;" name="name" type="text" placeholder="请输入权限名" value="{{$listArr->name}}"> *例如： admin.permission.add
                        </div>
                        ...
                        <div class="form-group form-inline  col-sm-12">
                            ...
                            <button class="btn btn-default" name="icon" data-iconset="fontawesome" data-icon="{{!empty($listArr->icon)?$listArr->icon:'fa-sliders'}}" role="iconpicker"></button> * 一级 二级权限请图标必填 
                        </div> 

                        <div class="form-group col-sm-12">
                            <label class="form-label pull-left col-sm-2" style="text-align: right;"></label>
                            <input class="btn btn-primary ajaxformsubmit" dataurl="{{route('admin.permission.ajaxedit')}}" type="button" value="保存">
