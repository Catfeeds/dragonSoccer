               ...
               <div class="row">
                    <form id="subform" method="POST" action="" accept-charset="UTF-8">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="form-control"  style="width:320px;" name="loginname" placeholder="请输入登陆名">
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="btn btn-primary ajaxformsubmit" dataurl="{{route('admin.school.ajaxadd')}}" type="button" value="保存">
