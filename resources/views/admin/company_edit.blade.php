               ...
               <div class="row">
                    <form id="subform" method="POST" action="" accept-charset="UTF-8">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="form-control"  style="width:320px;" name="name" placeholder="请输入名字" value="{{$listArr->name}}">
                        </div>

                        <div class="form-group form-inline col-sm-12">
                            <label class="form-label pull-left col-sm-2" style="text-align: right;">关键字:</label>
                            <input class="form-control" type="text"  style="width:320px;" name="key" placeholder="请输入关键字" value="{{$listArr->key}}" @if($type) readonly="readonly" @endif>
                        </div>

                        <div class="form-group form-inline col-sm-12">
                            <label class="form-label pull-left col-sm-2" style="text-align: right;">url:</label>
                            <input class="form-control" type="text"  style="width:320px;" name="url" placeholder="请输入关键字" value="{{$listArr->url}}">
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="btn btn-primary ajaxformsubmit" dataurl="{{route('admin.company.ajaxedit')}}" type="button" value="保存">
