               ...
               <div class="row">
                    <form id="subform" method="POST" action="" accept-charset="UTF-8">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control"  style="width:320px;" name="info" placeholder="请输入简介"></textarea>
                        </div>
                        ...
                        <div class="form-group form-inline col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group date form_datetime form-date-box pull-left" id="form_datetime" data-date="" data-date-format="yyyy-mm-dd">
                                        <input class="form-control" size="16" type="text" value="" name="applystime">
                            ...
                            <div class="form-group">
                                <div class="input-group date form_datetime form-date-box pull-left" id="form_datetime1" data-date="" data-date-format="yyyy-mm-dd">
                                    <input class="form-control" size="16" type="text" value="" name="applyetime">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div> 
                            </div>
                        </div>
                        ...
                        <div class="form-group  form-inline  col-sm-12 selectbtnbody" id="selectbtnbody{{$i}}">
                            <label class="form-label pull-left col-sm-1" style="text-align: right;">@if($i==0) 赛事图片: @endif</label>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="btn btn-primary ajaxformsubmit" dataurl="{{route('admin.games.ajaxadd')}}" type="button" value="保存">
...
$(document).ready(function (){
    $(".ajaxages").on("change",function(){  
        $.ajax({
            type: "get",
            url: '{{route("admin.games.ajaxages")}}'+'?ownerid='+$(this).find("option:selected").val(),
            dataType: "html",
